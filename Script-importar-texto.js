function NewUserArquivo(nome) {

    for (var NomePosicao = 0; NomePosicao < nome.length; NomePosicao++) {

        var usuario = nome[NomePosicao].split(" ");
        ...
        coluna1.innerText = nome[NomePosicao];
...
function NewUserArquivoSL(nome) {
    for (var NomePosicao = 0; NomePosicao < nome.length; NomePosicao++) {
